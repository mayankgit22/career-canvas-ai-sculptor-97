...
const BadgesSharing = () => {
  ...
  const communityStats = [
    { label: "Students Helped", value: "50,000+", change: "+12%" },
    { label: "Opportunities Matched", value: "2.5M+", change: "+8%" },
    { label: "Resumes Generated", value: "125K+", change: "+15%" },
    { label: "Success Stories", value: "3,200+", change: "+20%" }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold mb-4">Badges & Sharing</h1>
                    ...
                    {earnedBadges.map((badge, index) => {
                      ...
                      return (
                        <Card key={index} className={`transition-all duration-300 ${
                          badge.earned ? "ring-2 ring-yellow-500 shadow-lg" : "opacity-60"
                        }`}>
                          <CardContent className="p-4">
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                ...
                                {badge.earned ? (
                                  <p className="text-xs text-muted-foreground">Earned on {badge.earnedDate}</p>
                                ) : (
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="p-3 bg-muted rounded-lg">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">- Alex K.</p>
                    </div>
