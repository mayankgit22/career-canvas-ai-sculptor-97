...
const ProfileBuilder = () => {
  ...
  const profileSections = [
    { name: "Basic Information", completed: true, icon: User },
    { name: "Education", completed: true, icon: GraduationCap },
    { name: "Skills", completed: true, icon: Code },
    { name: "Projects", completed: false, icon: Briefcase },
    { name: "Goals", completed: false, icon: Target },
  ];
                        ...
                        return (
                          <div key={index} className="flex items-center gap-3">
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                              section.completed ? "bg-green-100 text-green-600" : "bg-muted text-muted-foreground"
                            }`}>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input id="projectTitle" placeholder="E-commerce Web Application" />
                  </div>
                  <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input id="projectLink" placeholder="https://github.com/..." />
                    </div>
                    <div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Textarea 
                      id="careerGoals" 
                      placeholder="I want to work as a software engineer at a tech company, focusing on AI and machine learning..."
                      rows={3}
                    />
                  </div>
                  <div>
                    <Label htmlFor="interests">Industry Interests</Label>
                    <Input id="interests" placeholder="Technology, Healthcare, Finance, etc." />
                  </div>
                </CardContent>
              </Card>
